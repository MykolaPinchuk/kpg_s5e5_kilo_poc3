...
def optimize_hyperparameters(X, y, n_trials=5):  # Reduced to 5 trials for testing
    """
    ...
    def objective(trial):
        ...
        scores = cross_val_score(model, X, y, cv=3, scoring='neg_mean_squared_log_error')  # Reduced CV folds
...
if __name__ == "__main__":
    ...
    # Optimize hyperparameters with full dataset and reduced trials for testing
    print("Optimizing hyperparameters...")
    best_params = optimize_hyperparameters(X_train, y_train, n_trials=5)  # Reduced to 5 trials
